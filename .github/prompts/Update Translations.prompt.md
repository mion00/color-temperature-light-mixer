...
- English: [#file:custom_components/color_temperature_light_mixer/translations/en.json]
- German: [#file:custom_components/color_temperature_light_mixer/translations/de.json]
